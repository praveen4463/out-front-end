...
import BuildIconRounded from '@material-ui/icons/BuildRounded';
    ...
    <SplitPane
      ...
      <Box display="flex" flexDirection="column" className={classes.root}>
        <Box
          ...
          boxShadow={1}>
          <Tooltip title="Re Parse">
            <IconButton aria-label="Re Parse" className={classes.iconNoHover}>
              <BuildIcon
                fontSize="small"
      ...
      <Box display="flex" flexDirection="column" className={classes.root}>
        <Box
          ...
          pl={1}>
          <Box flex={1}>
            <Typography variant="caption">Parsing...</Typography>
          </Box>
          {closeButton}
        </Box>
        <Box
          ...
          <pre className={classes.output}>
            Parse completed, no problems found
          </pre>
          <pre className={clsx(classes.output, classes.outputError)}>
            Extraneous input , at 8:10
          </pre>
        </Box>
      </Box>
    </SplitPane>
