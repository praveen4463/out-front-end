...
export const IdeBuildRunningContext = React.createContext(null);
export const IdeEditDlgContext = React.createContext(null);
export const IdeDryRunConfigContext = React.createContext(null);
export const IdeBuildRunBuildVarContext = React.createContext(null);
export const IdeBuildRunSelectedVersionsContext = React.createContext(null);
